...
##[![Typing SVG](https://readme-typing-svg.herokuapp.com/?lines=welcome+To+Movie-Bot!;created+by+Jasim+Vahab!;A+simple+autofilter+Bot!;Auto+filter+with+double+button!;start+message+with+pic!;and+all+futures!)
</p>
